...
{
    public class ShotgunWeaponController : WeaponController
    {
        public ShotgunWeaponController(WeaponData _weaponData, Transform _parentPanel,
        ...
        {
            EventService.OnPlaySoundEffectEvent.Invoke(SoundType.FIRE_SHOTGUN);
        }
    }
}